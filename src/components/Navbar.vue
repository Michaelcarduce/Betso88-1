...
<template>
  <nav
    :class="[
      ...
      'rounded-[14px] border-[1.5px] border-glow shadow-lg ',
      isMenuOpen ? 'w-full' : '',
    ]">
    <div
      :class="[
      ...
      <div
        ...
        <a
          href="/"
          :class="[
            'rounded-md px-3 py-2 hover:bg-yellow-400 transform transition-transform duration-200 hover:scale-105',
            route.path === '/'
